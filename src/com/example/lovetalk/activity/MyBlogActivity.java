	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setDate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				DatePickerDialog datePickerDialog = new DatePickerDialog(MyBlogActivity.this,
				...
				private void updateDate() {
					...
					new MyAsyncTask(mContext, false) {
						...
						protected void doInBack() throws Exception {
							...
							query.whereEqualTo("mobilePhoneNumber", myPhone);
											...
											public void done(List<AVObject> results, AVException e) {
												if (e != null) {
													...
													for (int i = 0; i < allBlog.size(); i++) {
														...
														String blogTimeAll = (String) DateUtils.formatDateTime(MyBlogActivity.this,
																timeLong, flagsTime);
													...
													BlogAdapter blogAdapter = new BlogAdapter(blogList,
															blogListTime, MyBlogActivity.this);
									...
									if (e != null) {
										...
										list.setOnItemClickListener(new OnItemClickListener() {
											...
											public void onItemClick(AdapterView<?> parent,
												...
												BlogAdapter blogAdapter = new BlogAdapter(blogList, blogListTime, MyBlogActivity.this);
												list.setAdapter(blogAdapter);
											}
