...
public class PhotoUtil {
  ...
  public static String compressImage(String path, String newPath) {
    ...
    int inSampleSize = 1;
    int maxSize = 3000;
    Log.d("lan","outWidth=" + options.outWidth + " outHeight=" + options.outHeight);
    ...
    Log.d("lan","inSampleSize=" + inSampleSize);
    ...
    //recycle(bitmap);
    Log.d("lan","bitmap width=" + newBitmap.getWidth() + " h=" + newBitmap.getHeight());
